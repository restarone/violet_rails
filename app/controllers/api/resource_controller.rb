class Api::ResourceController < Api::BaseController
  ...
  def resource_params
    ...
    params.require(:data).permit(non_primitive_properties_attributes: [:id, :label, :field_type, :content, :attachment, :_destroy]).merge({ api_namespace_id: @api_namespace.id, properties: properties })
  end

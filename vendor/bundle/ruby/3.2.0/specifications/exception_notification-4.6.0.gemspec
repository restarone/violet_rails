# -*- encoding: utf-8 -*-
# stub: exception_notification 4.6.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/smartinez87/exception_notification/blob/master/CHANGELOG.rdoc" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<actionmailer>.freeze, [">= 5.2", "< 9"])
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 5.2", "< 9"])

...
class Comfy::Admin::ApiNamespacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "#index: Rendering tab should include documentation on form snippet and API HTML renderer snippets" do
    ...
    assert_select "pre", {count: 1, text: "{{ cms:helper render_api_namespace_resource_index '#{@api_namespace.slug}', scope: { properties: { test_id: 123, obj: { a: \"b\", c: \"d\" }, title: \"Hello World\", published: true, arr: [1, 2, 3], alpha_arr: [\"a\", \"b\"] } } }}"}
    assert_select "b", {count: 1, text: "API HTML Renderer show snippet:"}
    assert_select "pre", {count: 1, text: "{{ cms:helper render_api_namespace_resource '#{@api_namespace.slug}', scope: { properties: { test_id: 123, obj: { a: \"b\", c: \"d\" }, title: \"Hello World\", published: true, arr: [1, 2, 3], alpha_arr: [\"a\", \"b\"] } } }}"}
    ...
    assert_select "pre", {count: 1, text: "{{ cms:helper render_api_namespace_resource_index '#{@api_namespace.slug}', scope: { properties: { title: { value: \"Hello\", option: \"KEYWORDS\" }, arr: { value: [1], option: \"KEYWORDS\" }, alpha_arr: { value: [\"a\"], option: \"KEYWORDS\" } } } }}"}
    assert_select "b", {count: 1, text: "API HTML Renderer show snippet (KEYWORDS - works for array and string data type only):"}
    assert_select "pre", {count: 1, text: "{{ cms:helper render_api_namespace_resource '#{@api_namespace.slug}', scope: { properties: { title: { value: \"Hello\", option: \"KEYWORDS\" }, arr: { value: [1], option: \"KEYWORDS\" }, alpha_arr: { value: [\"a\"], option: \"KEYWORDS\" } } } }}"}
  end
